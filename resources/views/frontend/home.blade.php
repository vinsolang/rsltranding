...
<section>
    <div class="main-banner bg-cover relative">
        ...
        >
            <source src="{{ asset('assets/vdo/log-apple-animation.webm') }}" type="video/webm">
        </video> --}}
        {{-- Version Mobile --}}
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4>{{ app()->getLocale() === 'en' ? 'Pepper ' : (app()->getLocale() === 'km' ? 'ម្រេច' : '佩珀') }}</h4>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4>{{ app()->getLocale() === 'en' ? 'Charcoal' : (app()->getLocale() === 'km' ? 'ធ្យូង' : '木炭') }}</h4>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4>{{ app()->getLocale() === 'en' ? 'Plantation Wood' : (app()->getLocale() === 'km' ? 'ឈើដាំ' : ' 种植林木') }}</h4>
