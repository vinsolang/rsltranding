...
@section('content')
                        ...
                        @foreach ($values as $v)
                            <div class="peace-card">
                               <div class="relative flex items-center pl-2">
                                ...
                                <p class="mt-[-5px] text-sm md:text-[15px] leading-relaxed text-[#FFFFFF]">
                                    {{ $v['desc'] }}
                                </p>
                                <div class=" peace-card text-center sm:text-left mt-3 h-[6px]  sm:w-32 md:w-[155px] lg:w-[195px] bg-[#8FD1AD] rounded-full"
                                ></div>
                            </div>
                        @endforeach
                    </div>
    ...
    <section class="mt-[260px] sm:mt-[200px] lg:mt-[440px] md:mt-[400px]">
