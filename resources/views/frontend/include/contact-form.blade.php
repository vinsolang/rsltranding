    ...
    <div class="col-lg-6 col-md-6 input-field">
      <div class="field-wrap">
        ...
        <select name="trade_type" id="tradeType" class="form-select" required>
          ...
          <option value="local_buying">{{ app()->getLocale() === 'en' ? 'Local Buying' : (app()->getLocale() === 'km' ? 'ការទិញក្នុងស្រុក' : '本地采购') }}</option>
        </select>
        <!-- <span class="star-inside">*</span> -->
      </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 input-field">
      <div class="field-wrap">
        <input class="col-12" name="email" required
          placeholder="{{ app()->getLocale() === 'en' ? 'Email' : (app()->getLocale() === 'km' ? 'សារអេឡិចត្រូនិក (អ៊ីមែល)' : '电子邮件') }}" style="font-family: Kantumruy Pro, sans-serif;">
        <span class="star-inside">*</span>
      </div>
    </div>
